        ...
        {books.map((book, index) => (
          ...
          >
            ...
            <div className="mt-5 flex items-center gap-2 border-t border-ivory-300 pt-4 text-xs text-zinc-500">
              ...
              <span>Luettu {formatFinnishDate(book.valmistumispaiva)}</span>
            </div>
          </Link>
        ))}
      </div>
